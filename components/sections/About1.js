                    ...
                    <div className="row ">
                        <div className="col-md-12 ">
                            ...
                            <div className="tf-heading wow fadeInUp">
                                ...
                                <p className="sub-heading">Community Services Of Minnesota Inc. we specialize in providing comprehensive consulting, coaching,
                                    auditing, and staff development services to healthcare agencies. Our mission is to ensure quality and compliance with policies and procedures, 
                                    helping agencies improve their programs and better serve their clients.</p>
                                {/* <p className="sub-heading">Community Services Of Minnesota Inc. is a conglomerate of services delegated to aid individuals and small businesses 
                                    to be the best version of themselves by “piecing together the pinnacle of success". It is owned and operated by Larry Ajala, located in Anoka 
                                    Minnesota, Larry Recently celebrated 10+ years working in human services field as a combined 10 years + of 245D/Assisted living service experience
                                    between him and his team. The mission of Community Services Of Minnesota Inc. as coach Larry is to provide fast and reliable services in auditing, 
                                    consulting, coaching, and staff development.</p> */}
                            </div>
                        ...
                        <div className="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div className="tf-step wow fadeInUp" data-wow-delay="0.2s">
                                <div className="step-title">
                                    ...
                                    <h3>Client-Centeredness</h3>
                                </div>
                                <p>We prioritize our clients' needs, tailoring solutions to ensure their utmost satisfaction.</p>
                            </div>
                        </div>
                        <div className="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div className="tf-step wow fadeInUp" data-wow-delay="0.3s">
                                ...
                                <p>We uphold the highest standards of honesty, transparency, and ethical conduct in everything.</p>
                            </div>
                        </div>
                        <div className="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div className="tf-step wow fadeInUp" data-wow-delay="0.4s">
                                ...
                                <p>We strive for superior performance and continuous improvement in all our services.</p>
                            </div>
                        </div>
                        <div className="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div className="tf-step wow fadeInUp" data-wow-delay="0.5s">
                                ...
                                <p>We embrace creativity and forward-thinking to deliver cutting-edge solutions for complex challenges.</p>
                            </div>
                        </div>
                    </div>
                </div>
