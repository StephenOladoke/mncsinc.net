                            ...
                            <div className="row ">
                                <div className="col-xl-6 col-lg-5 col-md-12 ">
                                    <div className="tf-heading style-2 wow fadeInUp">
                                        ...
                                        <p className="sub-heading">Our team of experienced professionals offer combined designated coordinator and manager contracted consulting services, providing routine oversight, evaluation, and support for program paperwork, 
                                        ensuring quality and program improvement. We also offer initial and ongoing operation and review of paperwork for clients, ensuring that your organization is always compliant with policies and procedures as it pertains to 
                                        the clients. Our reliable and fast services make us your trusted partner in achieving your goals and providing the best services to your clients.</p>
                                    ...
                                    <div className="counter-wrap">
                                        <div className="tf-counter wow fadeInUp">
                                            ...
                                            <div className="content">
                                                <CounterUp count={500} data-speed={500} />+
                                            </div>
                                        </div>
                                        <div className="tf-counter wow fadeInUp">
